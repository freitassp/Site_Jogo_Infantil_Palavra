...
function atualizarImagemCachorro(feliz) {
    if (feliz) {
        imagemCachorro.src = './img/cachorro_feliz.png'; // Caminho da imagem do cachorro feliz
    } else {
        imagemCachorro.src = './img/cachorro_triste.png'; // Caminho da imagem do cachorro triste
    }
}

// Função para reiniciar a imagem do cachorro para a imagem inicial (triste)
function reiniciarImagemCachorro() {
    imagemCachorro.src = './img/cachorro.png'; // Caminho da imagem inicial do cachorro
}
